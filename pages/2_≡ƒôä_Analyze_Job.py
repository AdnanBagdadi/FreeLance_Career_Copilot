...
if st.button("🔍 Analyze match", type="primary", disabled=not jd_text.strip()):
    ...
    st.switch_page("pages/3_🎯_Match_Results.py")

if not jd_text.strip():
    st.info("Paste or upload a job description, then click **Analyze match**.")
