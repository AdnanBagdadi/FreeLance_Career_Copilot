...
def require_login():
    ...
    # The card styling is applied directly to Streamlit's own block
    # container. Do NOT wrap the content in a custom <div> — Streamlit
    # auto-closes each markdown block, which leaves an empty box on screen.
    st.markdown(
        """
        <style>
